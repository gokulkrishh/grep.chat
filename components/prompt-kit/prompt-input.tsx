  ...
  return (
    <TooltipProvider>
      ...
      >
        <div
          className={cn(
            "border-input bg-background cursor-text touch-manipulation rounded-3xl border p-2 shadow-xs",
            className,
          )}
...
function PromptInputTextarea({
  ...
  return (
    <Textarea
      ...
      className={cn(
        "text-primary min-h-16 w-full resize-none border-none bg-transparent! shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0",
        className,
      )}
      rows={1}
      disabled={disabled}
